...
if not st.session_state.portfolio_df.empty:
    ...
    # Create a doughnut chart for normalized harm scores
    ...
    # Calculate normalized harm score * number of units and percentage of total
    st.session_state.portfolio_df['Units'] = st.session_state.portfolio_df['Units'].astype(float)
    
    # Calculate the product and percentage of total harm scores times units
    ...
    # Create a pie chart for harm score contributions
