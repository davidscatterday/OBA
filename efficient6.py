...
def optimize_portfolio_allocation(df, max_harm_score):
    ...
    # Set constraints for optimization: maximize returns subject to harm score constraint
    constraints = {'type': 'ineq', 'fun': lambda x: max_harm_score - np.dot(harm_scores, x)}

    # Optimize using Mean-Variance Optimization (MVO)
    optimized_weights = port.optimization(model='Classic',
